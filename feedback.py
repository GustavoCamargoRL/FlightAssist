...
def report():
    while(True):
        ...
        if(variables.found_smarts):
            ...
            output = cv.putText(output, str(variables.score_smarts), (20,470), font, fontScale+0.5, color, thickness, cv.LINE_AA)

        if(variables.found_smarter):
